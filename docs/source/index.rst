...
Before proceeding with the customization steps, it's important to update your system to ensure all packages are up-to-date.` sudo dnf system-upgrade download --releasever=rawhide`
